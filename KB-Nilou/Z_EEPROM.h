...
bool Z_EEPROM_Write_string_A(uint16_t START_Byte, uint16_t Bytes_Length, String i_Data)
{
...
void Z_EEPROM_Write_fill(uint16_t START_Byte, uint16_t Bytes_Length, byte i_Data)
{
...
void Z_EEPROM_Write_byte(uint16_t START_Byte, byte i_Data)
{
...
//开始字节位 欲存储的变量
void Z_EEPROM_Write_string(uint16_t START_Byte, String i_Data)
{
...
//读取Byte变量 1字节
//开始字节位  | 1字节 0-255
byte Z_EEPROM_Read_byte(uint16_t START_Byte)
{
